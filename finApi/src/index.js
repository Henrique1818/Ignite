...
app.post('/account', (request, response) => {
  ...
  return response.status(201).json({ message: "Create account"});
});
...
app.post('/deposit', verifyIfExistsAccountCPF, (request, response) => {
  ...
  return response.status(201).json({ message: 'Deposit made'});
});
...
app.post('/withdraw', verifyIfExistsAccountCPF, (request, response) => {
  ...
  return response.status(201).json({ message: 'Withdraw made'});
});
